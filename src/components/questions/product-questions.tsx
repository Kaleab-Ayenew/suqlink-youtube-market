...
const ProductQuestions: React.FC<ProductQuestionsProps> = ({
  ...
  return (
    <div className="block">
      <div className="flex w-[calc(100%+32px)] flex-col justify-between border-b border-t border-light-500 px-4 py-5 ltr:-ml-4 rtl:-mr-4 dark:border-dark-400 sm:flex-row sm:items-center md:mb-1 md:w-full md:border-b-0 md:border-t-0 md:px-0 md:py-0 ltr:md:ml-0 rtl:md:mr-0">
