  ...
  return (
    <div>
      ...
      <CheckBox
        ...
        checked={use_wallet}
        className={cn(
          'mb-7 mt-4 flex-row-reverse rounded border border-light-400 bg-light-100 py-2.5 hover:bg-transparent ltr:pr-2.5 rtl:pl-2.5 dark:border-dark-500/80 dark:bg-dark-400/80 dark:hover:bg-transparent',
      ...
      {use_wallet && (
        <div className="mb-7 mt-1 flex justify-between border-t-4 border-double border-light-400 pt-4 dark:border-dark-400">
