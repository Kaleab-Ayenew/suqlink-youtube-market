      ...
      <Listbox value={selected} onChange={setSelected}>
        <div className="relative">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Listbox.Options className="absolute z-30 mt-1 max-h-60 w-full overflow-auto rounded-md bg-light pb-2 pt-1 text-base shadow-dropdown dark:bg-dark-100">
  ...
  return (
    <div className="relative flex w-full flex-col overflow-hidden rounded-md bg-light p-4 shadow-card dark:bg-dark-200 dark:shadow-none xs:p-5 md:p-8 lg:flex-row lg:p-0">
      ...
      <motion.div
        ...
        className="w-full flex-grow pb-4 pt-4 sm:pb-2 md:pt-10 lg:p-10 xl:p-12"
      >
        {children}
      </motion.div>
    </div>
